...
const LIGHT = { text: 'text-[#2E3A56]', muted: 'text-[#64748B]', accent: 'text-[#2E3A56]', card: 'bg-gray-50 border border-gray-200', input: 'border-gray-200 bg-white text-[#2E3A56] placeholder-gray-400', btn: 'bg-[#2E3A56] text-white', btnSecondary: 'bg-gray-200 text-[#2E3A56]', progress: 'from-[#2E3A56] to-[#5A6B8A]' };
    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          <Target className={`w-5 h-5 ${variant === 'light' ? 'text-[#2E3A56]' : 'text-[#FCF6BA]'}`} />
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            style={variant === 'light' ? { background: '#2E3A56', color: 'white' } : { background: 'linear-gradient(45deg, #BF953F, #FCF6BA)', color: '#020617' }}
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#2E3A56]/30 focus:outline-none ${variant === 'light' ? 'border-gray-200 bg-white text-[#2E3A56] placeholder-gray-400' : 'border-white/10 bg-white/[0.04] text-[#F5F5F0] placeholder-[#F5F5F0]/40 focus:ring-[#FCF6BA]/30'}`}
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:outline-none ${variant === 'light' ? 'border-gray-200 bg-white text-[#2E3A56] focus:ring-[#2E3A56]/30' : 'border-white/10 bg-white/[0.04] text-[#F5F5F0] focus:ring-[#FCF6BA]/30'}`}
                  >
          ...
          goals.map((goal) => (
            ...
            >
              ...
              <div className="mb-4">
                ...
                <div className={`w-full rounded-full h-3 ${variant === 'light' ? 'bg-gray-200' : 'bg-white/10'}`}>
                  <motion.div
                    ...
                    className={`bg-gradient-to-r h-3 rounded-full ${variant === 'light' ? 'from-[#2E3A56] to-[#5A6B8A]' : 'from-[#BF953F] to-[#FCF6BA]'}`}
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                {goal.is_completed ? (
                  <span className={`flex items-center gap-1 font-bold ${variant === 'light' ? 'text-[#2E3A56]' : 'text-[#FCF6BA]'}`}>
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg transition-colors text-sm ${variant === 'light' ? 'bg-[#2E3A56]/20 text-[#2E3A56] hover:bg-[#2E3A56]/30' : 'bg-[#FCF6BA]/20 text-[#FCF6BA] hover:bg-[#FCF6BA]/30'}`}
                  >
                    {t('goals.complete')}
                  </button>
                ) : null}
