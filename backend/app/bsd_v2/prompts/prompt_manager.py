...
STAGE_GATES_HE: Dict[str, str] = {
    ...
    "S9": "**Gate (S9→S10):** פרדיגמה מנוסחת במילים של המתאמן (ללא דרישת פורמט ספציפי).",
...
STAGE_GATES_EN: Dict[str, str] = {
    ...
    "S9": "**Gate (S9→S10):** Paradigm formulated in the coachee's own words (no specific format required).",
