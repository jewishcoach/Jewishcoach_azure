...
- `collected_data` – **Important!** Update every turn with new data the user provided. S1: topic. S2: event_description (full description of the event the user described — keep in their words, including when/where/who/what). S3: emotions. S4: thought. S5: action_actual. S6: action_desired, emotion_desired, thought_desired. S7: gap_name, gap_score. S8: pattern. S9: paradigm ("this is how I am" action-paradigm). S11: stance (gains/losses). S12: forces (source/nature - KaMaZ). S13: renewal (new choice/new stance). S14: vision. S15: commitment (concrete first step). Insights are shown live to the user – never return empty collected_data.
