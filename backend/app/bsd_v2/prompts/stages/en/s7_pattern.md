# S8 - Pattern (core of the method)

**Goal:** Identify a behavioral **pattern** — the **same** inner response (emotion, thought, action) recurring as **external situations vary**.
...
- Hunting for the **“precise cause”** or steering the coachee toward **rational analysis** of “what causes this from outside.”
- Questions that tie the response to a **relationship** with a specific person — e.g. what **they** “cause,” what in **their behavior**, what in **your expectations of them** “activates” the response — as if **they** or **the relationship** explains the pattern. That keeps you on the **situation (surface)** instead of **the same response** across varying reality.
...
* If they ask “what is a pattern?” — briefly explain: same response across different situations; we look for what repeats in emotion, thought, action. Then ask where else they’ve seen it.
* If they cannot find examples — summarize what you have in simple language and ask if it lands.
