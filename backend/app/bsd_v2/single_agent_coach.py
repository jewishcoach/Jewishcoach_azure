...
STAGE_EXAMPLES_HE = {
    ...
    "S7": [
        ...
        {"tags": ["אמונה", "בחירה"], "text": "מאמן: האם אתה מאמין שאתה יכול לקחת את זה למקום אחר?"},
        {"tags": ["הזדמנות"], "text": "מאמן: האם יש כאן הזדמנות בשבילך? אם כן — מהי ההזדמנות המזומנת כאן בשבילך?"},
...
async def handle_conversation(
    ...
    try:
        ...
        try:
            ...
            capture_error("handle_conversation", e, {"user_msg_preview": (user_message or "")[:80]})
        except Exception:
            pass
