...
# עקרונות יסוד
1. אל תחפור - קיבלת תשובה מספקת? התקדם. לא לשאול "מה עוד?" שוב ושוב
...
S2: אירוע ספציפי - 4 תנאים: זמן(2w-2m)+מעורבות+רגש+אנשים+מגע (לא רק נוכחות)
...
זכור: אל תחפור. קיבלת תשובה — התקדם.
"""
