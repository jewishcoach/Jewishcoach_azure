...
from ..models import CoachFeedbackSurveySubmission
...
coach_feedback_survey_router = APIRouter(
    prefix="/api/coach-feedback-survey",
    tags=["coach-feedback-survey"],
)
...
def _validate_coach_survey_responses(responses: dict[str, Any]) -> dict[str, Any]:
    ...
    for key in _COACH_SURVEY_REQUIRED_CHOICE_KEYS:
        val = cleaned.get(key)
...
@coach_feedback_survey_router.post("/submit")
...
@coach_feedback_survey_router.get("/submissions")
