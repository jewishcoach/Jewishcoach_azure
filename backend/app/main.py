...
from .routers import chat, speech, feedback, users, journal, tools, admin, billing, profile, calendar, onboarding_email_admin
...
app.include_router(onboarding_email_admin.router)
